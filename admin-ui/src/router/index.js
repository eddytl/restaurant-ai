...
const routes = [
  { path: '/login', name: 'login', component: () => import('@/views/LoginView.vue'), meta: { public: true } },
  {
    ...
    children: [
      ...
      { path: 'insights', name: 'insights', component: () => import('@/views/InsightsView.vue'), meta: { adminOnly: true } },
      { path: 'admin-chat', name: 'admin-chat', component: () => import('@/views/AdminChatView.vue'), meta: { adminOnly: true } },
